      ...
      <form action="order_send.php" method="POST"> <!-- 你可以根據需求修改 action -->
        ...
        <div class="container section-title" data-aos="fade-up">
          ...
          <fieldset>
            <legend>請選擇辣度：</legend>
            <label>
              <input type="radio" name="spiciness" value="無" required checked> 無
            </label>
            <label>
              <input type="radio" name="spiciness" value="再微辣" required> 再微辣
            </label>
            <label>
              <input type="radio" name="spiciness" value="微辣" required> 微辣
            </label>
            <label>
              <input type="radio" name="spiciness" value="小辣" required> 小辣
            </label>
            <label>
              <input type="radio" name="spiciness" value="中辣" required> 中辣
            </label>
            <label>
              <input type="radio" name="spiciness" value="中小辣" required> 中小辣
            </label>
            <label>
              <input type="radio" name="spiciness" value="包辣" required> 包辣
            </label>
          </fieldset>
          <fieldset>
            <legend>請選擇口味：</legend>
            ...
            <label>
              <input type="radio" name="flavor" value="重" checked required> 重
            </label>
            <label>
              <input type="radio" name="flavor" value="清淡" required> 清淡
            </label>
            <label>
              <input type="radio" name="flavor" value="不加醬" required checked> 不加醬
            </label>
            <label>
              <input type="radio" name="flavor" value="麻辣" required> 麻辣
            </label>
            <label>
              <input type="radio" name="flavor" value="豚骨" required> 豚骨
            </label>
          </fieldset>
          <fieldset>
            <legend>請選擇作法：</legend>
            ...
            <label>
              <input type="radio" name="preparation" value="乾" required> 乾
            </label>
            <label>
              <input type="radio" name="preparation" value="半湯" required> 半湯
            </label>
            <label>
              <input type="radio" name="preparation" value="全湯" required checked> 全湯
            </label>
            <label>
              <input type="radio" name="preparation" value="包湯" required> 包湯
            </label>
          </fieldset>
          <fieldset>
            <legend>配料內容：</legend>
            <div>
              <label>
                <input type="radio" name="scallion_option" value="多蔥" required> 多蔥
              </label>
              <label>
                <input type="radio" name="scallion_option" value="不加蔥" required checked> 不加蔥
              </label>
            </div>
            <div>
              <label>
                <input type="radio" name="pickled_cabbage_option" value="多加酸菜" required> 多加
              </label>
              <label>
                <input type="radio" name="pickled_cabbage_option" value="不加酸菜" required checked> 不加
              </label>
            </div>
          </fieldset>
        </div><!-- End Section Title -->
