...
(2, 2, '死神辣辣麵', 150, '火鍋類', 1),
(3, 3, '麻辣套餐', 150, '火鍋類', 1),
(4, 4, '麻辣鴨血臭臭鍋', 120, '火鍋類', 1),
(5, 5, '韓式泡菜臭臭鍋', 120, '火鍋類', 1),
(6, 6, '大腸鴨血臭臭鍋', 120, '火鍋類', 1),
(7, 7, '招牌鴨血臭臭鍋', 100, '火鍋類', 1),
(8, 8, '韓國拉麵', 35, '主食麵類', 1),
(9, 9, '蒸煮麵', 25, '主食麵類', 1),
(10, 10, '媽媽拉麵', 20, '主食麵類', 1),
(11, 11, '烏龍麵', 25, '主食麵類', 1),
(12, 12, '王子麵', 15, '主食麵類', 1),
(13, 13, '極品意麵', 20, '主食麵類', 1),
(14, 14, '極品雞絲麵', 20, '主食麵類', 1),
(15, 15, '統一脆麵', 20, '主食麵類', 1),
(16, 16, '關廟麵', 20, '主食麵類', 1),
(17, 17, '入味冬粉', 15, '主食麵類', 1),
(18, 18, '入味河粉', 15, '主食麵類', 1),
(19, 19, '無骨湯燒雞排', 35, '上等肉類', 1),
(20, 20, '滷肉排', 35, '上等肉類', 1),
(21, 21, '豬肉片', 30, '上等肉類', 1),
(22, 22, '牛肉片', 30, '上等肉類', 1),
(23, 23, '隔間肉', 40, '上等肉類', 1),
...
(30, 30, '豬皮', 15, '上等肉類', 1),
(31, 31, '鴨心', 20, '上等肉類', 1),
(32, 32, '手工大黑豆干', 25, '豆品類', 1),
(33, 33, '五香豆干', 15, '豆品類', 1),
(34, 34, '手工蘭花干', 25, '豆品類', 1),
(35, 35, '手工豆包', 10, '豆品類', 1),
(36, 36, '手工百頁豆腐', 15, '豆品類', 1),
(37, 37, '上等大油皮', 20, '豆品類', 1),
(38, 38, '菜頭', 10, '其他類', 1),
(39, 39, '手工大蝦捲', 25, '其他類', 1),
(40, 40, '大熱狗', 25, '其他類', 1),
(41, 41, '德國香腸', 25, '其他類', 1),
(42, 42, '日式玉子燒', 25, '其他類', 1),
(43, 43, '麻辣鴨血臭豆腐', 25, '其他類', 1),
(44, 44, '狀元米腸', 20, '其他類', 1),
(45, 45, '手工牛母', 25, '其他類', 1),
(46, 46, '手工甜不辣', 15, '其他類', 1),
(47, 47, '海帶卷', 10, '其他類', 1),
(48, 48, '小熱狗', 15, '其他類', 1),
(49, 49, '手工黑輪', 15, '其他類', 1),
(50, 50, '雪魚燒', 15, '其他類', 1),
(51, 51, '日式竹輪', 10, '其他類', 1),
(52, 52, '黃金豆腐', 15, '其他類', 1),
(53, 53, '手工鴨米血', 15, '其他類', 1),
(54, 54, '麻辣鴨血', 15, '其他類', 1),
(55, 55, '凍豆腐', 10, '其他類', 1),
(56, 56, '滷蛋', 15, '其他類', 1),
(57, 57, '麻辣臭豆腐', 10, '其他類', 1),
(58, 58, '油條', 15, '其他類', 1),
(59, 59, '手工水晶餃', 15, '其他類', 1),
(60, 60, '雪魚丸', 5, '火鍋料類', 1),
(61, 61, '魚餃', 5, '火鍋料類', 1),
(62, 62, '燕餃', 5, '火鍋料類', 1),
(63, 63, '鴨肉丸', 5, '火鍋料類', 1),
(64, 64, '小蝦球', 5, '火鍋料類', 1),
(65, 65, '魚卵卷', 5, '火鍋料類', 1),
(66, 66, '龍蝦沙拉', 15, '火鍋料類', 1),
(67, 67, '魚包蛋', 15, '火鍋料類', 1),
(68, 68, '爆濃起司球', 15, '火鍋料類', 1),
(69, 69, '麻吉燒（芝麻）', 15, '火鍋料類', 1),
(70, 70, '麻吉燒（花生）', 15, '火鍋料類', 1),
(71, 71, '新竹大貢丸', 15, '火鍋料類', 1),
(72, 72, '蟹肉棒', 15, '火鍋料類', 1),
(73, 73, '起司魚豆腐', 15, '火鍋料類', 1),
(74, 74, '鑫鑫腸', 5, '火鍋料類', 1),
(75, 75, '韓國年糕', 5, '火鍋料類', 1),
(76, 76, '烏蛋', 5, '火鍋料類', 1),
(77, 77, '章魚球', 15, '火鍋料類', 1),
...
(93, 93, '秀針菇', 20, '香菇類', 1),
(94, 94, '杏鮑菇', 20, '香菇類', 1),
(95, 95, '特選黑木耳', 20, '香菇類', 1),
(96, 96, '金針菇', 20, '香菇類', 1),
(97, 97, '菠菜', 20, '冬季蔬菜類', 1),
(98, 98, '茼蒿', 20, '冬季蔬菜類', 1),
(99, 99, '山茼蒿', 20, '冬季蔬菜類', 1);
...
--
ALTER TABLE `customer`
  MODIFY `Customer_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '顧客 ID', AUTO_INCREMENT=13;
...
--
ALTER TABLE `order`
  MODIFY `Order_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '訂單 ID', AUTO_INCREMENT=6;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `order_item`
--
ALTER TABLE `order_item`
  MODIFY `Item_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '訂單項目 ID', AUTO_INCREMENT=10;
