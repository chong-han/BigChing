...
CREATE TABLE `order` (
  ...
  `Order_Booking` datetime DEFAULT NULL COMMENT '預訂'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `order` (`Order_ID`, `Customer_ID`, `Order_Date`, `Order_exit`, `Pickup_Code`, `Order_Remark`, `Order_Booking`) VALUES
(9, 13, '2025-05-30 18:47:41', 1, '1', '辣度: 無, 口味: 重, 作法: 全湯, 蔥: 不加蔥, 酸菜: 不加酸菜', NULL),
(10, 6, '2025-05-22 18:56:09', 0, '699517', '辣度: 中辣, 口味: 重, 作法: 全湯, 蔥: 不加蔥, 酸菜: 不加', NULL),
(11, 13, '2025-05-18 18:56:09', 0, '899605', '辣度: 再微辣, 口味: 清淡, 作法: 包湯, 蔥: 不加蔥, 酸菜: 多加', NULL),
(12, 6, '2025-05-23 18:56:09', 0, '644463', '辣度: 小辣, 口味: 清淡, 作法: 半湯, 蔥: 不加蔥, 酸菜: 多加', NULL),
(13, 13, '2025-05-25 18:56:09', 0, '355502', '辣度: 再微辣, 口味: 重, 作法: 半湯, 蔥: 多蔥, 酸菜: 多加', NULL),
(14, 3, '2025-05-27 18:56:09', 0, '002887', '辣度: 中辣, 口味: 重, 作法: 包湯, 蔥: 多蔥, 酸菜: 不加', NULL),
(15, 4, '2025-05-06 18:56:09', 0, '982147', '辣度: 微辣, 口味: 重, 作法: 半湯, 蔥: 多蔥, 酸菜: 多加', NULL),
(16, 8, '2025-05-11 18:56:09', 0, '441386', '辣度: 再微辣, 口味: 豚骨, 作法: 包湯, 蔥: 不加蔥, 酸菜: 不加', NULL),
(17, 1, '2025-05-12 18:56:09', 0, '338427', '辣度: 包辣, 口味: 清淡, 作法: 乾, 蔥: 多蔥, 酸菜: 多加', NULL),
(18, 4, '2025-05-17 18:56:09', 0, '074202', '辣度: 無, 口味: 重, 作法: 乾, 蔥: 不加蔥, 酸菜: 多加', NULL),
(19, 11, '2025-05-06 18:56:09', 0, '170730', '辣度: 微辣, 口味: 不加醬, 作法: 半湯, 蔥: 不加蔥, 酸菜: 不加', NULL),
(20, 9, '2025-05-05 18:56:09', 0, '411360', '辣度: 小辣, 口味: 清淡, 作法: 全湯, 蔥: 不加蔥, 酸菜: 多加', NULL),
(21, 1, '2025-05-07 18:56:09', 0, '867981', '辣度: 無, 口味: 不加醬, 作法: 乾, 蔥: 不加蔥, 酸菜: 多加', NULL),
(22, 9, '2025-05-16 18:56:09', 0, '436137', '辣度: 中辣, 口味: 清淡, 作法: 乾, 蔥: 不加蔥, 酸菜: 多加', NULL),
(23, 5, '2025-05-20 18:56:09', 0, '304152', '辣度: 小辣, 口味: 不加醬, 作法: 全湯, 蔥: 不加蔥, 酸菜: 不加', NULL),
(24, 13, '2025-05-11 18:56:09', 0, '121568', '辣度: 中辣, 口味: 麻辣, 作法: 全湯, 蔥: 多蔥, 酸菜: 多加', NULL),
(25, 4, '2025-05-10 18:56:09', 0, '781179', '辣度: 包辣, 口味: 重, 作法: 包湯, 蔥: 多蔥, 酸菜: 多加', NULL),
(26, 7, '2025-05-24 18:56:09', 0, '843473', '辣度: 小辣, 口味: 重, 作法: 包湯, 蔥: 不加蔥, 酸菜: 多加', NULL),
(27, 9, '2025-05-18 18:56:09', 0, '291238', '辣度: 再微辣, 口味: 豚骨, 作法: 半湯, 蔥: 多蔥, 酸菜: 多加', NULL),
(28, 8, '2025-05-18 18:56:09', 0, '380816', '辣度: 中辣, 口味: 清淡, 作法: 全湯, 蔥: 多蔥, 酸菜: 多加', NULL),
(29, 11, '2025-05-08 18:56:09', 0, '023008', '辣度: 包辣, 口味: 清淡, 作法: 乾, 蔥: 不加蔥, 酸菜: 不加', NULL),
(36, 11, '2025-05-31 15:19:17', 1, '1', '辣度: 無, 口味: 重, 作法: 全湯, 蔥: 不加蔥, 酸菜: 不加酸菜', NULL),
(37, 15, '2025-05-31 15:21:17', 1, '2', '辣度: 包辣, 口味: 豚骨, 作法: 包湯, 蔥: 不加蔥, 酸菜: 不加酸菜', NULL),
(38, 11, '2025-05-31 15:24:37', 1, '3', '辣度: 包辣, 口味: 豚骨, 作法: 包湯, 蔥: 不加蔥, 酸菜: 不加酸菜', NULL),
(39, 11, '2025-05-31 15:38:52', 1, '4', '辣度: 無, 口味: 重, 作法: 全湯, 蔥: 不加蔥, 酸菜: 不加酸菜', NULL),
(40, 13, '2025-06-05 16:15:59', 1, '1', '辣度: 包辣, 口味: 豚骨, 作法: 包湯, 蔥: 不加蔥, 酸菜: 不加酸菜', '2025-06-05 10:15:59'),
(41, 13, '2025-06-05 16:18:52', 1, '2', '辣度: 無, 口味: 重, 作法: 全湯, 蔥: 不加蔥, 酸菜: 不加酸菜', '2025-06-06 20:00:00'),
(42, 13, '2025-06-05 16:19:31', 1, '3', '辣度: 無, 口味: 重, 作法: 全湯, 蔥: 不加蔥, 酸菜: 不加酸菜', NULL);
...
--
ALTER TABLE `order`
  MODIFY `Order_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '訂單 ID', AUTO_INCREMENT=43;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `order_item`
--
ALTER TABLE `order_item`
  MODIFY `Item_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '訂單項目 ID', AUTO_INCREMENT=73;
